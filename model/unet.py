...
class BeatGANsEncoderConfig(BaseConfig):
    ...
    def make_model(self):
        if not self.use_hf:
            ...
            return EncoderModelHF(self)


class EncoderModelHF(nn.Module):
    """
    The encoder model pretrained on medical images, such as UNI and Ctranspath.
    """
    def __init__(self, conf: BeatGANsEncoderConfig):
        ...
        self.adapter = nn.Sequential(
            ...
            nn.GELU(),
            nn.Linear(self.num_features, conf.out_channels),
        )
